...
@section('section')
    <div class="pcoded-inner-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.states.index') }}">Состоянии</a></li>
        ...
        <form action="{{ route('admin.states.update', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
