...
@section('section')
    <div class="pcoded-inner-content">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('admin.additional-functions.index') }}">Дополнительные функции</a></li>
        ...
        <form action="{{ route('admin.additional-functions.update', ['id' => $data->id]) }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
