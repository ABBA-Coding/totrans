...
@section('section')
    <div class="pcoded-inner-content">
        ...
        <form action="{{ route('admin.applications.import-post') }}" method="post" enctype="multipart/form-data">
            {{ csrf_field() }}
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <a href="/applications_import.xlsx" download="Шаблон" class="btn-link">Скачать шаблон</a>
                            </div>
                        </div>
                    </div>
