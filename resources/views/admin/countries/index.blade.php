                        ...
                        <div class="d-flex align-items-center justify-content-between">
                            <div>
                                ...
                                <ul class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item"><a href="javascript:">Страны</a></li>
                                </ul>
                            </div>
                            <a href="{{ route('admin.countries.create') }}" class="btn btn-primary mr-0">Добавить</a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                @if (count($data) > 0)
                                    @foreach($data as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn-link" href="{{ route('admin.cities.index', ['country_id' => $item->id]) }}">Городы ({{ count($item->cities) }})</a>
                                            </td>
                                            <td>
                                                {!! $item->statusUI !!}
                                            </td>
                                            <td>
                                                ...
                                                <a
                                                    href="{{ route('admin.countries.destroy', ['id' => $item->id]) }}"
